  ...
  <div id="table-container" class="table-container">
    <vab-query-form>
      ...
      <vab-query-form-right-panel>
        ...
        >
          <el-form-item>
            <el-input v-model="queryForm.name" placeholder="变量名称" />
          </el-form-item>
          <el-form-item>
            <el-button
              icon="el-icon-search"
      ...
      <el-table-column show-overflow-tooltip label="创建者">
        <template #default="{ row }">
          <el-tooltip
            ...
            placement="top-start"
          >
            <el-tag :type="row.user | statusFilter">
              {{ row.user }}
            </el-tag>
          </el-tooltip>
        </template>
...
<script>
  import { getList, doDelete, GetProList } from '@/api/project/global'
  import TableEdit from './components/data'
  export default {
