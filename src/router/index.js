...
export const asyncRoutes = [
  ...
  },
  {
    ...
    redirect: 'noRedirect',
    name: 'tools',
    meta: { title: '工具管理', icon: 'gavel' },
    children: [
      {
        path: 'quadrature',
        name: '正交工具',
        component: () => import('@/views/tools/quadrature'),
        meta: { title: '正交工具' },
      },
      {
        path: 'test',
  ...
  },
  {
    ...
    redirect: 'noRedirect',
    name: 'http',
    meta: { title: '接口框架', icon: 'baby' },
    children: [
      {
        path: 'runner',
        name: 'runner',
        component: () => import('@/views/requesttools/httprunner'),
        meta: { title: 'HTTPRUNER' },
      },
      {
        path: 'test',
        name: '测试',
  ...
  },
  {
    ...
    redirect: 'noRedirect',
    name: 'global',
    meta: { title: '变量管理', icon: 'bible' },
    children: [
      {
        path: 'global',
        name: '全局变量',
        component: () => import('@/views/global/global_data'),
        meta: { title: '全局变量' },
      },
      {
        path: 'test',
